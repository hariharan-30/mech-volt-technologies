        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {service.features?.slice(0, 6).map((item) => (
              <div
                key={item}
                className="flex items-start gap-3 rounded-xl bg-slate-50 p-4 border border-slate-200 hover:border-orange-400 hover:shadow-md transition-all duration-300"
              >
                <FaCheckCircle className="mt-1 text-orange-500 shrink-0" />
                <span className="text-slate-700">{item}</span>
              </div>
            ))}
          </div>

  ...
  return (
    <div className="max-w-3xl mx-auto text-center">
      ...
      <p className="mt-6 text-base sm:text-lg text-slate-600 leading-8">
        Looking for reliable industrial automation solutions? Our engineering
        team is ready to help with Industrial Robotics Programming, SPM Machine
        Design & Industrial Automation, Jigs & Fixtures, Conveyor Systems, PLC
        Programming and Control Panel Services.
      </p>
    </div>
  );
};
